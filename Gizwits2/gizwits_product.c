...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
    ...
    for(i=0; i<info->num; i++)
    {
        ...
        case EVENT_r:
            ...
            rgb_set_color(currentDataPoint.valuer, currentDataPoint.valueg, currentDataPoint.valueb);
            break;
        case EVENT_g:
        ...
        case EVENT_motor:
            ...
            motor_set_speed(currentDataPoint.valuemotor);
            break;
...
void userHandle(void)
{
    ...
    currentDataPoint.valuer = rgb_r;
    currentDataPoint.valueg = rgb_g;
    currentDataPoint.valueb = rgb_b;
}
